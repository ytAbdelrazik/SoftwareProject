...
const submit_response_dto_1 = require("./dtos/submit-response.dto");
let ResponsesController = class ResponsesController {
    constructor(responseService) {
        this.responseService = responseService;
    }
    async createResponse(submitResponseDto) {
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [submit_response_dto_1.SubmitResponseDto]),
    __metadata("design:returntype", Promise)
], ResponsesController.prototype, "createResponse", null);
exports.ResponsesController = ResponsesController = __decorate([
    (0, common_1.Controller)('responses'),
    __metadata("design:paramtypes", [responses_service_1.ResponseService])
], ResponsesController);
