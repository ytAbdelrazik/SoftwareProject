...
const user_interaction_dto_1 = require("./dtos/user-interaction.dto");
let InteractionController = class InteractionController {
    constructor(interactionService) {
        this.interactionService = interactionService;
    }
    async createInteraction(createInteractionDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [user_interaction_dto_1.CreateInteractionDto]),
    __metadata("design:returntype", Promise)
], InteractionController.prototype, "createInteraction", null);
exports.InteractionController = InteractionController = __decorate([
    (0, common_1.Controller)('interactions'),
    __metadata("design:paramtypes", [user_interaction_service_1.InteractionService])
], InteractionController);
//# sourceMappingURL=user-interaction.controller.js.map