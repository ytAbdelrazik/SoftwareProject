...
let RecommendationController = class RecommendationController {
    ...
    async createRecommendation(userId, recommendedItems) {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)('recommendedItems')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Array]),
    __metadata("design:returntype", Promise)
], RecommendationController.prototype, "createRecommendation", null);
